...
RSpec.describe "Process payments for a registration", :focus => :payment do
  it " Happy day parent registers and pays for registration" do
  ...
  context "pre-existing student registrations" do
    ...
    it "Parent renews registration and pays" do
    ...
    it "Parent has one new and old registration pays for new registration" do
      parent.students.each do|student|
        click_link "register_student_#{student.id}"
        do_fillin_registration_fields
        student.reload
    ...
    it "Parent should not be able to pay for past registration" do
      page.should have_no_selector "pay"
    end

    it "Parent with old registrations creates new student registration can pay for new registration only" do
      do_create_new_student
      click_link "pay"
      current_path.should == new_payment_path
    ...
    it "Parent should only be charged for active registrations",:js => true  do
  ...
  context "with current student registrations" do
    ...
    let(:user){parent.user}
    it "Parent should not be able to pay for wait-list registration" do
    ...
    it "Parent should not be able to pay for already paid-for registration" do
