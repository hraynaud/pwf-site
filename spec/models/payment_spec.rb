...
describe Payment do
  ...
  describe "#save_with_stripe_payment" do
    let(:payment){FactoryBot.build(:stripe_payment, :parent => FactoryBot.create(:parent))}
  ...
  context "PayPal payments" do
    ...
    let(:payment){FactoryBot.build(:paypal_payment,:parent => FactoryBot.create(:parent))}
  ...
  describe "#confirm_registrations" do
    it "should update the student registrations" do
      ...
      payment = FactoryBot.build(:completed_payment, :parent =>parent, :program => :fencing )
    ...
    it "should update the aep registrations" do
      ...
      parent.student_registrations.each do |reg|
        reg.confirmed_paid!
        reg.save
        FactoryBot.create(:complete_aep_registration, :student_registration => reg)
      end
      payment = FactoryBot.build(:completed_payment, :parent =>parent, :program => :aep )
