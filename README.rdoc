...
Parents access the site via the main (parent) link http://peterwestbrook-aep.herokuapp.com.
PWF staff and admins typically login to the site here: http://peterwestbrook-aep.herokuapp.com/admin

The backend uses a customized ActiveAdmin as the backend administrative interface. 
